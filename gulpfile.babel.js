...
/**
 * tipy Theme
 * Copyright 2020 tipy. All rights reserved.
 */
...
const
    themeRoot = 'wp-content/themes/tipy',
...
gulp.task('styles:dev', gulp.series('scss-lint', () => {
...
gulp.task('styles:build', gulp.series('scss-lint', 'clean:map', () => {
    return gulp.src(srcRoot + '/styles/scss/style.scss')
        .pipe($.plumber())
        .pipe($.sass({
            precision: 10
